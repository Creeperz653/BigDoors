...
abstract class ClassGenerator
{
    public static final Method METHOD_VERIFY_CLASS =
        findMethod().inClass(IVerifiableClass.class).withName("generated$verifyClass").get();
    ...
    protected final @NotNull DynamicType.Builder<?> createBuilder(@NotNull Class<?> superClass)
    {
        return new ByteBuddy()
            ...
            .implement(IGeneratedClass.class, IVerifiableClass.class)
    ...
    public interface IVerifiableClass
    {
        /**
